...
function setup() {
  ...
  car3 = createSprite(50, 250, 50, 25);
  car4 = createSprite(50, 350, 50, 25);
  wall1 = createSprite(1000, 50, 25, 50);
  wall2 = createSprite(1000, 150, 25, 50);
  wall3 = createSprite(1000, 250, 25, 50);
  wall4 = createSprite(1000, 350, 25, 50);
}
